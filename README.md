...
---
#### 功能简介 
weui+是Zepto1.2和weui.js,weui1.13等众多开源项目中,参考而成的,接近100个新组件,最目前全网效果最全的.喜欢这个的童鞋们别吝啬去打小星星哦.
#### 更新日志
- 2018-9-1 v5.0 本次升级是大版本升级,与4.9.x完全不兼容,也是一次重构,weui v1.1.3,zepto1.2,将分为基础/表单/组件/js方法/css类5大分类,js/css文件尽量都有一份未压缩版本以供修改.weui将作为独立文件,不影响独立升级,不兼容jquery,所以请勿再多问.
